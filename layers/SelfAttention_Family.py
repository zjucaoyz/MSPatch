...
from Time_Series_Library.utils.masking import TriangularCausalMask, ProbMask
...
class MSPatchLinearAttention(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask, tau=None, delta=None, attn=None):
...
class MSPatchAttentionLayer(nn.Module):
    def __init__(self, attention, d_model, n_heads, d_keys=None,
                 d_values=None):
        super(MSPatchAttentionLayer, self).__init__()
